...
type Alert = { id: string; title: string; source: string; ago: string; severity: 'low'|'medium'|'high' };
  ...
  return (
    <div className="clip-corner border border-primary/20">
      ...
      <div className="px-2 pb-3 space-y-2">
        {alerts.map(a => (
          <div key={a.id} className="px-3 py-2 border clip-corner-sm bg-card/20 flex items-center gap-3"
